...
-- ========================================================
-- PARTE 1: USUÁRIOS E ENDEREÇOS (O que você já tinha)
-- ========================================================
...
-- ========================================================
-- PARTE 2: NOVAS TABELAS (Adicionar a partir daqui)
-- ========================================================

-- Inserir Tipos de Telefone (PhoneType)
...
-- Inserir Telefones (UserPhone) - 2 telefones para cada usuário
INSERT INTO UserPhone(user_phone_id, phone_type_id, phone_number, is_active, web_user_id, created_date)
VALUES
    (1, 1, '8015550100', true, 1, CURRENT_TIMESTAMP),
    (2, 3, '8015550101', true, 1, CURRENT_TIMESTAMP),
    (3, 1, '8015550200', true, 2, CURRENT_TIMESTAMP),
    (4, 4, '8015550201', true, 2, CURRENT_TIMESTAMP);

ALTER SEQUENCE UserPhone_user_phone_id_seq RESTART WITH 5;

-- Inserir Informações de Perfil (UserInfo) - 1 para cada usuário com as fotos do Canvas
INSERT INTO UserInfo(user_info_id, web_user_id, profile_bio, profile_picture, created_date, modified_date)
VALUES
    (1, 1, 'Main administrator account for CS415 platform.', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTYZ4AiSTOD6IbZ-zuTTghcjbMr15XMj1XSQ&s', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2, 2, 'Legendary country music singer and database tester.', 'https://is1-ssl.mzstatic.com/image/thumb/Features125/v4/b4/c2/9a/b4c29a1e-3b45-2b60-be65-dbb96d21e42a/mza_1383128222591135178.png/375x375bb.jpg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

ALTER SEQUENCE UserInfo_user_info_id_seq RESTART WITH 3;

-- Inserir Dados das Páginas (PageData) - Cronograma completo do curso
